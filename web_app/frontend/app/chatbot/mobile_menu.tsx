  ...
  !minimized ? (
    <>
      <div className="md:hidden">
        <div className="fixed inset-0 z-40 bg-black/50" onClick={() => setMinimized(true)} />
        <div className="fixed left-0 top-0 bottom-0 z-50 w-72 max-w-[80vw] bg-gray-900 border-r border-gray-700 p-4 shadow-xl">
          <Menu minimized={minimized} setMinimized={setMinimized} username={username} onRequestLogout={onRequestLogout} />
        </div>
      </div>
    </>
  ) : null
